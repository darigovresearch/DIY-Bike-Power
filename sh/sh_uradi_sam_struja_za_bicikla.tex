...
\title{Uradi Sam Struja Za Bicikla}
...
{\color{blue}\section{Predgovor}} % (fold)
\label{sec:predgovor}
...
% section predgovor (end)

\newpage

{\color{blue}\section{Uvod}} % (fold)
\label{sec:uvod}
...
{\color{blue}\section{Prije poćetka}} % (fold)
\label{sec:prije_poćetka}
...
% section prije_poćetka (end)

\newpage

{\color{blue}\section{Pravljenje jednostavnog generatora bicikla}} % (fold)
\label{sec:pravljenje_jednostavnog_generatora_bicikla}
...
% section pravljenje_jednostavnog_generatora_bicikla (end)

{\color{blue}\section{Sastavljanje generatora bicikla}} % (fold)
\label{sec:sastavljanje_generatora_bicikla}
...
% section sastavljanje_generatora_bicikla (end)

{\color{blue}\section{Korištenje upotreba više generatora bicikla}} % (fold)
\label{sec:koristenje_upotreba_više_generatora_bicikla}
...
% section koristenje_upotreba_više_generatora_bicikla (end)

{\color{blue}\section{Izvori}} % (fold)
\label{sec:izvori}
  ...
  \subsubsection{Bike Generator Providers} % (fold)
  ...
  % subsubsection bike_generator_providers (end)
