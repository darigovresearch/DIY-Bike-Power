...
{\color{blue}\section{Prefazione}} % (fold)
\label{sec:prefazione}

  \subsection*{Introduzione} % (fold)
...
% section prefazione (end)

\newpage

{\color{blue}\section{Introduzione}} % (fold)
...
\section{Prima di iniziare} % (fold)
\label{sec:prima_di_iniziare}

% section prima_di_iniziare (end)

{\color{blue}\section{Prima di iniziare}} % (fold)
\label{sec:prima_di_iniziare}
...
{\color{blue}\section{Costruire un semplice generatore da bicicletta}} % (fold)
...
% section costruire_un_semplice_generatore_da_bicicletta (end)

{\color{blue}\section{Assemblare il generatore da bicicletta}} % (fold)
...
% section assemblare_il_generatore_da_bicicletta (end)

{\color{blue}\section{Utilizzare diversi generatori da bicicletta}} % (fold)
...
% section utilizzare_diversi_generatori_da_bicicletta (end)

{\color{blue}\section{Risorse}} % (fold)
\label{sec:risorse}
...
{\color{blue}\section{Appendice}} % (fold)
\label{sec:appendice}
